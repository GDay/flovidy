...
class Flovidy_Plugin extends Flovidy_LifeCycle {
    ...
    public function getOptionMetaData() {
        return array(
            ...
            'license' => array(__('License', 'flovidy')),
    ...
    public function show_admin_notices() {
        $option = get_option( 'Flovidy_Plugin_license' );
     
        if ($option == "" ) {
     
            $msg = __( 'Please enter your license key to enable Flovidy' );
            ?>
                <div class="update-nag">
                    ...
                    <p>
                        <a href="<?php echo admin_url( 'options-general.php?page=Flovidy_PluginSettings' ); ?>">
                            <?php _e( 'Complete the setup now.' ); ?>
                        </a>
                    </p>
                </div>
            <?php
